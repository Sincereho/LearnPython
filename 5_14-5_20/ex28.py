...
print('1 == 1 and not ("testing" == 1 or 1 == 0)', 1 == 1
      and not ("testing" == 1 or 1 == 0), "True")
print('"chunky" == "bacon" and not (3 == 4 or 3 == 3)', "chunky" == "bacon"
      and not (3 == 4 or 3 == 3), "False")
print('3 == 3 and not ("testing" == "testing" or "Python" == "Fun")', 3 == 3
      and not ("testing" == "testing" or "Python" == "Fun"), "False")
